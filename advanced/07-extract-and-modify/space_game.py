...
def visit_planet(planet, engines, copilot, credits, crystal_found, dead):
    ...
    return planet, destinations, credits, engines, copilot, crystal_found, dead
...
def travel():
    ...
    while not crystal_found and not dead:

        display_inventory(credits, engines, copilot)

        planet, destinations, credits, engines, copilot, crystal_found, dead = \
            visit_planet(planet, engines, copilot, credits, crystal_found, dead)
